...
export default function PolycogniTestnet() {
  ...
  const stats = [
    { icon: "/icons/total_transactionc390.png",  target: 2294029, label: t("totalTx"),  useImg: true },
    { icon: "/icons/transactiond33f.png",         target: 43200,   label: t("dailyTx"),  useImg: true },
    { icon: "/icons/walletff59.png",              target: 2552,    label: t("wallets"),  useImg: true },
    { icon: null,                                 target: 2295594, label: t("blocks"),   useImg: false },
  ];
