...
\restrict ca7GGjjySK2iu80eEEDErRhKrqX9IJ5sV2YgeigxJgCT53Wsl5uMey3mGStXq0H
...
DROP POLICY IF EXISTS "Users can view their own deposit sessions" ON public.deposit_sessions;
DROP POLICY IF EXISTS "Users can update their own staking positions" ON public.staking_positions;
DROP POLICY IF EXISTS "Users can update their own notifications" ON public.notifications;
DROP POLICY IF EXISTS "Users can read their own staking positions" ON public.staking_positions;
...
DROP POLICY IF EXISTS "Service role can update deposit sessions" ON public.deposit_sessions;
DROP POLICY IF EXISTS "Service role can insert transactions" ON public.transactions;
DROP POLICY IF EXISTS "Service role can insert notifications" ON public.notifications;
DROP POLICY IF EXISTS "Service role can insert deposit sessions" ON public.deposit_sessions;
DROP POLICY IF EXISTS "SELECT policy" ON public.transactions;
DROP POLICY IF EXISTS "No client writes to staking plans" ON public.staking_plans;
DROP POLICY IF EXISTS "Enable users to view their own data only" ON public.profiles;
DROP POLICY IF EXISTS "Enable insert for users based on user_id" ON public.profiles;
DROP POLICY IF EXISTS "Anyone can read staking plans" ON public.staking_plans;
DROP POLICY IF EXISTS "Allow service role to manage coins" ON public.coins;
DROP POLICY IF EXISTS "Allow public read access" ON public.coins;
DROP POLICY IF EXISTS "Allow authenticated users to read coins" ON public.coins;
DROP POLICY IF EXISTS "Admins can modify staking plans" ON public.staking_plans;
...
ALTER TABLE IF EXISTS ONLY public.staking_positions DROP CONSTRAINT IF EXISTS staking_positions_plan_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.wallets DROP CONSTRAINT IF EXISTS wallets_address_key;
ALTER TABLE IF EXISTS ONLY public.transactions DROP CONSTRAINT IF EXISTS transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.swap_rates DROP CONSTRAINT IF EXISTS swap_rates_pkey;
ALTER TABLE IF EXISTS ONLY public.staking_positions DROP CONSTRAINT IF EXISTS staking_positions_pkey;
...
ALTER TABLE IF EXISTS ONLY public.deposit_sessions DROP CONSTRAINT IF EXISTS deposit_sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.coins DROP CONSTRAINT IF EXISTS coins_pkey;
...
--
-- Name: deposit_sessions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: swap_rates; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.wallets (
    ...
    created_at timestamp with time zone,
    address text DEFAULT 'poly_7f3a9c1b2d8e4f'::text NOT NULL
);


--
-- Name: COLUMN wallets.address; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.wallets.address IS 'deposit address';
...
--
-- Name: deposit_sessions deposit_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.staking_plans
    ADD CONSTRAINT staking_plans_pkey PRIMARY KEY (id);
...
--
-- Name: swap_rates swap_rates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.swap_rates
    ADD CONSTRAINT swap_rates_pkey PRIMARY KEY (from_coin, to_coin);
...
--
-- Name: staking_positions staking_positions_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staking_positions
    ADD CONSTRAINT staking_positions_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.staking_plans(id);
...
--
-- Name: staking_plans Admins can modify staking plans; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can modify staking plans" ON public.staking_plans USING ((EXISTS ( SELECT 1
...
--
-- Name: coins Allow authenticated users to read coins; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to read coins" ON public.coins FOR SELECT TO authenticated USING (true);


--
-- Name: coins Allow public read access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow public read access" ON public.coins FOR SELECT USING (true);


--
-- Name: coins Allow service role to manage coins; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow service role to manage coins" ON public.coins TO service_role USING (true) WITH CHECK (true);


--
-- Name: staking_plans Anyone can read staking plans; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can read staking plans" ON public.staking_plans FOR SELECT USING (true);


--
-- Name: profiles Enable insert for users based on user_id; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable insert for users based on user_id" ON public.profiles FOR INSERT WITH CHECK ((id = auth.uid()));


--
-- Name: profiles Enable users to view their own data only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: staking_plans No client writes to staking plans; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "No client writes to staking plans" ON public.staking_plans TO authenticated USING (false) WITH CHECK (false);


--
-- Name: transactions SELECT policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "SELECT policy" ON public.transactions FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: deposit_sessions Service role can insert deposit sessions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role can insert deposit sessions" ON public.deposit_sessions FOR INSERT WITH CHECK (true);
...
--
-- Name: deposit_sessions Service role can update deposit sessions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role can update deposit sessions" ON public.deposit_sessions FOR UPDATE USING (true) WITH CHECK (true);


--
-- Name: wallets Service role can update wallets; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role can update wallets" ON public.wallets FOR UPDATE USING (true) WITH CHECK (true);


--
-- Name: staking_positions Users can create their own staking positions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can create their own staking positions" ON public.staking_positions FOR INSERT WITH CHECK ((user_id = auth.uid()));
...
--
-- Name: staking_positions Users can read their own staking positions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can read their own staking positions" ON public.staking_positions FOR SELECT USING ((user_id = auth.uid()));
...
--
-- Name: staking_positions Users can update their own staking positions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update their own staking positions" ON public.staking_positions FOR UPDATE USING ((user_id = auth.uid())) WITH CHECK ((user_id = auth.uid()));


--
-- Name: deposit_sessions Users can view their own deposit sessions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own deposit sessions" ON public.deposit_sessions FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: coins; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.coins ENABLE ROW LEVEL SECURITY;

--
-- Name: deposit_sessions; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: staking_plans; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: swap_rates; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: TABLE coins; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE deposit_sessions; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.deposit_sessions TO postgres;
GRANT ALL ON TABLE public.deposit_sessions TO anon;
GRANT ALL ON TABLE public.deposit_sessions TO authenticated;
GRANT ALL ON TABLE public.deposit_sessions TO service_role;
...
--
-- Name: TABLE staking_plans; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.staking_plans TO postgres;
GRANT ALL ON TABLE public.staking_plans TO anon;
GRANT ALL ON TABLE public.staking_plans TO authenticated;
GRANT ALL ON TABLE public.staking_plans TO service_role;
...
GRANT ALL ON TABLE public.staking_positions TO postgres;
...
--
-- Name: TABLE swap_rates; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.swap_rates TO postgres;
GRANT ALL ON TABLE public.swap_rates TO anon;
GRANT ALL ON TABLE public.swap_rates TO authenticated;
GRANT ALL ON TABLE public.swap_rates TO service_role;
...
--
-- Name: TABLE messages_2026_03_31; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_01; Type: ACL; Schema: realtime; Owner: -
--
...
\unrestrict ca7GGjjySK2iu80eEEDErRhKrqX9IJ5sV2YgeigxJgCT53Wsl5uMey3mGStXq0H
